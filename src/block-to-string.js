...
const annotateEquation = ifTrue(pick("equation"), ({ content }) => ({ content: `$${content}$` }), id);
...
const annotateStrikethrough = ifTrue(pick("strikethrough"), ({ content }) => ({ content: `~~${content}~~` }), id);
const annotateUnderline = ifTrue(pick("underline"), ({ content }) => ({ content: `<u>${content}</u>` }), id);
